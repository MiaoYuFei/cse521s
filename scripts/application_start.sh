...
sudo -u $WEB_USER ENV=production SOCK=$RUN_PATH/backend.sock $PM2 start --name $APPLICATION_NAME-BACKEND app.js -o $LOG_PATH/backend.log -e $LOG_PATH/backend.log
